...
const tracksPerPage = 8; // Number of tracks to load initially and on each "Load More" click
...
const RelatedTracks = () => {
  ...
  useEffect(() => {
    // Initialize with the first set of tracks
    setDisplayedTracks(tracksData.slice(0, tracksPerPage));
    // Check if there are more tracks than initially displayed
