...
const Settings = () => {
  return (
    <div className="flex w-full flex-col items-center bg-white px-4 py-6 md:py-8 lg:py-10">
      <div className="w-full max-w-7xl px-4 py-2.5">
      ...
      <div className="flex w-full max-w-7xl flex-col items-start gap-4 rounded-2xl border border-zinc-300 bg-[#E8E9E9] p-4 md:gap-5 md:p-6 lg:p-8">
