...
const ctaData = {
  ...
  subtitle:
    "Join thousands of professionals who trust VehicleCheck Pro for their daily vehicle compliance needs.",
  buttons: [
    {
...
const CTASection = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-12 bg-blue-600 px-4 py-24 text-center sm:px-12 md:px-16 lg:px-24">
      {/* Title and Subtitle */}
      <div className="flex w-full max-w-7xl flex-col items-center justify-center gap-4">
        <h2 className="text-2xl font-bold text-white sm:text-3xl md:text-[40px]">
          {title}
        </h2>
      ...
      <div className="flex w-full flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
        {buttons.map((button, index) => (
          <button key={index} className={buttonClasses(button.type)}>
